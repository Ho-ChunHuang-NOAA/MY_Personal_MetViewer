...
with open(plot_xml_file, 'a') as xml:
    ...
    xml.write("        <tmpl>\n")
    xml.write("            <data_file>"+label_area+"_"+plot_var.upper()+"_"+verf_cycle_id.upper()+"_"+header_date+".data</data_file>\n")
    xml.write("            <plot_file>"+label_area+"_"+plot_var.upper()+"_"+verf_cycle_id.upper()+"_"+figure_date+".png</plot_file>\n")
    xml.write("            <r_file>plot_"+label_area+"_"+plot_var.upper()+"_"+verf_cycle_id.upper()+"_"+header_date+".R</r_file>\n")
    xml.write("            <title>MET_"+plot_var.upper()+"_"+verf_cycle_id.upper()+"_"+header_date+" - "+label_area+"</title>\n")
    xml.write("            <x_label>Forecast Hours</x_label>\n")
    xml.write("            <y1_label>"+y_label.upper()+"</y1_label>\n")
    xml.write("            <y2_label/>\n")
    xml.write("            <caption/>\n")
    xml.write("            <job_title>plot_"+label_area+"_"+plot_var.upper()+"_"+verf_cycle_id.upper()+"_"+database_date+"</job_title>\n")
    ...
    xml.write("        <legend_inset>c(0.2,0.975)</legend_inset>\n")
