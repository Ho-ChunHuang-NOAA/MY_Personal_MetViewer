...
if stat_var == "o3":
    plot_var = "timeseries_ozcon1_L0_G148_valid"+sdate.title_date_format+"00to"+edate.title_date_format"23_"
else:
    plot_var = stat_var.lower()+"_ozcon1_L0_G148_valid"+sdate.title_date_format+"00to"+edate.title_date_format"23_"

ybuf="0.04"

models = [ "PROD", "PROD_BC" ]
lend_mdl = [ "GFS-CMAQ", "GFS-CMAQ-BiasCorr" ]
...
with open(plot_xml_file, 'a') as xml:
    ...
    #  xml.write("        <database>mv_g2o_met_o3pm_b_prod_"+database_date+"</database>\n")
    xml.write("        <database>mv_g2o_met_o3pm_b_prod_202206,mv_g2o_met_o3pm_b_prod_202207,mv_g2o_met_o3pm_b_prod_202208,mv_g2o_met_o3pm_b_prod_202209</database>\n")
    ...
    xml.write("        </series1>\n")
    xml.write("        <plot_fix>\n")
    xml.write("            <field equalize=\""+event_equal_flag+"\" name=\"fcst_var\">\n")
    xml.write("                <set name=\"fcst_var_0\">\n")
    xml.write("                    <val>OZCON1</val>\n")
    xml.write("                </set>\n")
    xml.write("            </field>\n")
    ...
    xml.write("            <plot_file>"+plot_var.upper()+"_"+verf_day_id.upper()+"_"+verf_cycle_id.upper()+"_"+figure_date+".png</plot_file>\n")
    ...
    xml.write("            <x_label>Success Ratio (1-FAR)</x_label>\n")
    xml.write("            <y1_label>Probability of Detection (POD)</y1_label>\n")
    ## xml.write("            <y2_label/>\n")
    xml.write("            <y2_label>CSI</y2_label>\n")
    capt = "Fbias-Dash Line, CSI-Shadded, Obs Threshold = "
    for csi in csi_thresh:
        capt = capt+csi+","
    str_len = len(capt)-1
    ...
    xml.write("        <varianceinflationfactor>true</varianceinflationfactor>\n")
    ...
    xml.write("        <xlab_size>1</xlab_size>\n")
    ...
    xml.write("        <legend_inset>c(0.5,-0.20)</legend_inset>\n")
    ...
    xml.write("        <caption_size>1.5</caption_size>\n")
    xml.write("        <caption_offset>2.88</caption_offset>\n")
    xml.write("        <caption_align>-0.08</caption_align>\n")
    ...
    xml.write("        <plot_cmd/>\n")
    xml.write("        <legend>c(\"RAW\",\"BiasCorr\")</legend>\n")
