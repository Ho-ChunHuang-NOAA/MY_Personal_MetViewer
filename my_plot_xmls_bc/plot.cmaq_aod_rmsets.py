...
title_var ="cmaq_aod_"+stat_var[0:4]
### PASSED AGRUEMENTS
if len(sys.argv) < 7:
...
with open(plot_xml_file, 'a') as xml:
    ...
    xml.write("            <title>MET_"+title_var.upper()+"_"+verf_day_id.upper()+"_"+verf_cycle_id.upper()+"_"+aod_qc_flag.upper()+"_"+database_date+" - "+label_area+"</title>\n")
    ...
    xml.write("        <colors>c(\"#000000FF\")</colors>\n")
