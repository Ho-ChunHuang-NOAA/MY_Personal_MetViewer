...
with open(plot_xml_file, 'a') as xml:
    ...
    xml.write("        <tmpl>\n")
    xml.write("            <data_file>plot_plot_CMAQ_PM25_Time_Series_DAY2_12Z.data</data_file>\n")
    xml.write("            <plot_file>plot_plot_CMAQ_PM25_Time_Series_DAY2_12Z.png</plot_file>\n")
    xml.write("            <r_file>plot_plot_CMAQ_PM25_Time_Series_DAY2_12Z.R</r_file>\n")
    xml.write("            <title>Time Series of surface Layer PM25 - ALL REG DAY 2 12Z</title>\n")
    xml.write("            <x_label>DAY</x_label>\n")
    xml.write("            <y1_label>Concentration ug/m^3</y1_label>\n")
    xml.write("            <y2_label/>\n")
    xml.write("            <caption/>\n")
    xml.write("            <job_title>plot_CMAQ_PM25_Time_Series_DAY2_12Z</job_title>\n")
