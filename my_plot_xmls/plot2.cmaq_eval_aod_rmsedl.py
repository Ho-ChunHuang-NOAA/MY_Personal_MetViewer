...
with open(plot_xml_file, 'a') as xml:
    ...
    xml.write("        </plot_fix>\n")
    xml.write("        <plot_cond/>\n")
    xml.write("        <indep equalize=\"false\" name=\"fcst_lead\">\n")
    vhour = vhour_beg
    ...
    xml.write("            <title>MET_"+title_var.upper()+"_"+verf_cycle_id.upper()+"_"+aod_qc_flag.upper()+"_"+sdate.strftime(title_time_format)+"_"+edate.strftime(title_time_format)+" - "+label_area+"</title>\n")
    ...
    xml.write("        <xtlab_size>1.1</xtlab_size>\n")
