...
##    xml.write("            </field>\n")
    ...
    date = sdate
    while date <= edate:
        ### print(date.strftime(val_date_format))
        if date.hour >= 10:
    ...
    xml.write("        <tmpl>\n")
    xml.write("            <data_file>"+label_area+"_"+plot_var.upper()+"_"+sdate.strftime(title_date_format)+"_"+edate.strftime(title_date_format)+".data</data_file>\n")
    xml.write("            <plot_file>"+label_area+"_"+plot_var.upper()+"_"+sdate.strftime(title_date_format)+"_"+edate.strftime(title_date_format)+".png</plot_file>\n")
    xml.write("            <r_file>plot_"+label_area+"_"+plot_var.upper()+".R</r_file>\n")
    xml.write("            <title>"+plot_var.upper()+" - "+label_area+"</title>\n")
    xml.write("            <x_label>TIME</x_label>\n")
    xml.write("            <y1_label>AOD</y1_label>\n")
    xml.write("            <y2_label/>\n")
    xml.write("            <caption/>\n")
    xml.write("            <job_title>plot_"+label_area+"_"+plot_var.upper()+"</job_title>\n")
    ...
    xml.write("        <plot_disp>c(TRUE,TRUE,TRUE,FALSE,FALSE,TRUE)</plot_disp>\n")
    xml.write("        <colors>c(\"#ff0000FF\",\"#800080FF\",\"#0000ffFF\",\"#ff00ffFF\",\"#ff00ffFF\",\"#000000FF\")</colors>\n")
    xml.write("        <pch>c(20,20,20,20,20,20)</pch>\n")
    xml.write("        <type>c(\"l\",\"l\",\"l\",\"p\",\"p\",\"l\")</type>\n")
    xml.write("        <lty>c(1,1,1,1,1,1)</lty>\n")
    xml.write("        <lwd>c(2,2,2,2,2,2)</lwd>\n")
    xml.write("        <con_series>c(0,0,0,1,1,0)</con_series>\n")
    xml.write("        <order_series>c(3,4,2,5,6,1)</order_series>\n")
    xml.write("        <plot_cmd/>\n")
    xml.write("        <legend>c(\"PARA12\",\"PARA87H\",\"PROD\",\"OBS12\",\"OBS87h\",\"OBS\")</legend>\n")
    xml.write("        <create_html>FALSE</create_html>\n")
## autoscaling    xml.write("        <y1_lim>c()</y1_lim>\n")
