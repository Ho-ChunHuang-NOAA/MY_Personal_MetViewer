...
with open(plot_xml_file, 'a') as xml:
    ...
    xml.write("            <y2_label/>\n")
    xml.write("            <caption/>\n")
    xml.write("            <job_title>plot_"+label_area+"_"+plot_var.upper()+"_"+verf_day_id.upper()+"_"+verf_cycle_id.upper()+"_"+figure_date+"</job_title>\n")
    ...
    xml.write("        <type>c(\"l\",\"l\",\"h\",\"h\")</type>\n")
    xml.write("        <lty>c(2,2,1,1)</lty>\n")
    xml.write("        <lwd>c(3,3,4,4)</lwd>\n")
