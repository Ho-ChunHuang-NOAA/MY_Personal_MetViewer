...
##    xml.write("            </field>\n")
    ...
    xml.write("        <xtlab_horiz>0.9</xtlab_horiz>\n")
    ...
    xml.write("        <colors>c(\"#ff0000FF\",\"#0000ffFF\",\"#ff00ffFF\",\"#000000FF\")</colors>\n")
    xml.write("        <pch>c(20,20,20,20)</pch>\n")
    xml.write("        <type>c(\"l\",\"l\",\"p\",\"l\")</type>\n")
    xml.write("        <lty>c(1,1,1,1)</lty>\n")
    xml.write("        <lwd>c(2,2,2,2)</lwd>\n")
    xml.write("        <con_series>c(0,0,1,0)</con_series>\n")
    xml.write("        <order_series>c(3,2,4,1)</order_series>\n")
    xml.write("        <plot_cmd/>\n")
    xml.write("        <legend>c(\"PARA12\",\"PROD\",\"OBS12\",\"OBS\")</legend>\n")
