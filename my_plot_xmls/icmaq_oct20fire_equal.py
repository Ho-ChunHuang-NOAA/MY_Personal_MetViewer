...
ymin="0.0"
ybuf="0.01"
models = [ "PM_PARA6D", "PM_PROD", "PM_V150A" ]
...
with open(plot_xml_file, 'a') as xml:
    ...
    xml.write("        <database>mv_g2o_met_verf_cmaqo3pm_oct20fire</database>\n")
    ...
    xml.write("        <event_equal>true</event_equal>\n")
    ...
    xml.write("        <xtlab_size>4</xtlab_size>\n")
    xml.write("        <xlab_weight>1</xlab_weight>\n")
    xml.write("        <xlab_size>6</xlab_size>\n")
    ...
    xml.write("        <ytlab_size>4</ytlab_size>\n")
    xml.write("        <ylab_weight>1</ylab_weight>\n")
    xml.write("        <ylab_size>6</ylab_size>\n")
    ...
    xml.write("        <plot_cmd/>\n")
    xml.write("        <legend>c(\"GFS-CMAQ\",\"NAM-CMAQ\",\"v150a\",\"\",\"OBS\",\"\")</legend>\n")
