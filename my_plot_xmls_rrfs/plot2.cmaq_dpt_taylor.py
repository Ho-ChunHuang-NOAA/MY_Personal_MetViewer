...
if stat_var == "dpt":
    ...
    plot_var = "cmaq_dpt_"+stat_var.lower()
...
with open(plot_xml_file, 'a') as xml:
    ...
    xml.write("        <legend_inset>c(0.05,0.75)</legend_inset>\n")
    xml.write("        <legend_ncol>2</legend_ncol>\n")
    xml.write("        <legend_size>1.5</legend_size>\n")
