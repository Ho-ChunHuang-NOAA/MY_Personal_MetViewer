...
tmp_data_dir="/lfs/h2/emc/stmp/Ho-Chun.Huang/working/check_fcst_lead_"+database_date
...
with open(plot_xml_file, 'a') as xml:
    ...
    xml.write("                    <stat>VL1L2_BIAS</stat>\n")
    xml.write("                </fcst_var>\n")
    xml.write("            </dep1>\n")
    xml.write("            <dep2/>\n")
    xml.write("        </dep>\n")
    ...
    xml.write("        </indep>\n")
    xml.write("        <agg_stat>\n")
    xml.write("            <agg_vl1l2>true</agg_vl1l2>\n")
    ...
    xml.write("            <circular_block_bootstrap>true</circular_block_bootstrap>\n")
    xml.write("        </agg_stat>\n")
