...
y_label="Daily max 8HR-AVG O3 CONC (ppb)"
### PASSED AGRUEMENTS
if len(sys.argv) < 7:
...
with open(plot_xml_file, 'a') as xml:
    ...
    xml.write("        <legend_inset>c(0.15,1.15)</legend_inset>\n")
    ...
    xml.write("            <line color=\"#000000\" line_pos=\"70\" lty=\"2\" lwd=\"2\" type=\"horiz_line\"/>\n")
    xml.write("        </lines>\n")
    ...
    xml.write("        <plot_disp>c(TRUE,TRUE,TRUE,TRUE,TRUE,,FALSE,FALSE,FALSE)</plot_disp>\n")
    xml.write("        <colors>c(\"#0000ffFF\",\"#0000ffFF\",\"#ff0000FF\",\"#ff0000FF\",\"#000000FF\",\"#000000FF\",\"#000000FF\",\"#000000FF\")</colors>\n")
    xml.write("        <pch>c(20,20,20,20,20,20,20,20)</pch>\n")
    xml.write("        <type>c(\"l\",\"l\",\"l\",\"l\",\"p\",\"p\",\"p\",\"p\")</type>\n")
    xml.write("        <lty>c(1,2,1,2,1,1,1,1)</lty>\n")
    xml.write("        <lwd>c(3,3,3,3,3,3,3,3)</lwd>\n")
    xml.write("        <con_series>c(1,1,1,1,0,0,0,0)</con_series>\n")
    xml.write("        <order_series>c(1,2,3,4,5,6,7,8)</order_series>\n")
    xml.write("        <plot_cmd/>\n")
    xml.write("        <legend>c(\"PROD\",\"PROD_BC\",\"v70c43\",\"v70c43_bc\",\"OBS\",\"\",\"\",\"\")</legend>\n")
