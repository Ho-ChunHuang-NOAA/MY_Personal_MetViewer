...
with open(plot_xml_file, 'a') as xml:
    ...
    xml.write("        <database>mv_g2o_met_icmaq_aug19,mv_g2o_met_icmaq_aug19v150a,mv_g2o_met_icmaq_aug19v161a</database>\n")
    ...
    xml.write("        <colors>c(\"#006400FF\",\"#0000ffFF\",\"#ff0000FF\",\"#000000FF\",\"#000000FF\",\"#000000FF\")</colors>\n")
    ...
    xml.write("        <plot_cmd/>\n")
    xml.write("        <legend>c(\"NAM-CMAQ\",\"v150a\",\"v161a\",\"OBS\",\"\",\"\")</legend>\n")
