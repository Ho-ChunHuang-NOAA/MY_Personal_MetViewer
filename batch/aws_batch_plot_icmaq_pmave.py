...
### PASSED AGRUEMENTS
if len(sys.argv) < 4:
    print("you must set 4 arguments as stat[pmave|rmse|...] [06|12|all] [day1|day2|day3|all] start_date end_date event_equal[optional]")
    sys.exit()
else:
    stat_var = sys.argv[1]
    flag_cyc  = sys.argv[2]
...
xml_gen_python_name = "plot2.cmaq_b_pmave_"+stat_var.lower()+".py"
