...
if len(sys.argv) < 5:
    print("you must set 4 arguments as stat[ozmax8|rmse|...] [day1|day2|day3] start_date end_date event_equal[optional]")
    sys.exit()
else:
    stat_var = sys.argv[1]
...
xml_gen_python_name = "plot2.fixed_yaxis_ozmax8_"+stat_var.lower()+".py"
