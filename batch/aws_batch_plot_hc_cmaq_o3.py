...
### PASSED AGRUEMENTS
if len(sys.argv) < 4:
    print("you must set 4 arguments as stat[o3|rmse|...] [day1|day2|day3] start_date end_date")
    sys.exit()
else:
    stat_var = sys.argv[1]
...
if stat_var == "rmsedl" or stat_var == "medl" or stat_var == "o3dl":
   vday=[ "day2", "day3" ]
run_cycle = [ "06Z", "12Z" ]
...
xml_gen_python_name = "plothc.cmaq_o3_"+stat_var.lower()+".py"
plot_xml_file = "plot_cmaqv5p6_o3_"+stat_var.lower()+".xml"
