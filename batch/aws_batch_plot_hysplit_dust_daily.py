...
xml_gen_python_name = "plot.hysplit_dust_"+stat_var.lower()+"_daily.py"
plot_xml_file = "plot_hysplit_dust_"+stat_var.lower()+"_daily.xml"
    ...
    for verf_day in vday: 
        for verf_cycle in run_cycle: 
            for verf_csi in csi_thresh: 
                ...
                subprocess.call(["python", xml_gen_python_name, area, area, verf_day.lower(), fig_sdate, fig_edate, verf_cycle, verf_csi])
                fig_file=area+"_HYSPLIT_DUST_"+stat_var.upper()+"_"+verf_day.upper()+"_"+verf_cycle+"_"+database_date+"_"+verf_csi+".png"
