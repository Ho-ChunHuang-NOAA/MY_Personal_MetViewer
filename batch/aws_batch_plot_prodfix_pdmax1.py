...
### PASSED AGRUEMENTS
if len(sys.argv) < 4:
    print("you must set 4 arguments as stat[pdmax1|rmse|...] [day1|day2|day3] start_date end_date event_equal[optional]")
    sys.exit()
else:
    stat_var = sys.argv[1]
...
xml_data_dir = "/lfs/h2/emc/vpppg/save/"+os.environ['USER']+"/METviewer_AWS/my_plot_xmls_prod"
xml_gen_python_name = "plot2.fixed_yaxis_pdmax1_"+stat_var.lower()+".py"
