...
# Print usage
usage() {
   echo "USAGE: mv_load_python_to_aws.sh <user_name> <base_dir> <xml_file>"
...
#run load on AWS
ssh ${USER_NAME}@${AWS_IP} "/opt/metviewer/bin/mv_load_python_aws.sh ${USER_NAME} ${XML_FILE_NAME}"
