...
obs_id="airnow"
if stat_var == "o3":
    plot_var = eval_id+"_o3_time_series"
    figfile = eval_id+"_"+obs_id+"_o3_time_series"
else:
    plot_var = eval_id+"_o3_"+stat_var.lower()
    figfile = eval_id+"_"+obs_id+"_o3_"+stat_var.lower()
...
models = [ "OZBCPARA6A", "OZBCPROD", "OZPARA6A", "OZPROD" ]
...
with open(plot_xml_file, 'a') as xml:
    ...
    xml.write("        <show_signif>c(FALSE,TRUE,FALSE,TRUE)</show_signif>\n")
