...
ymin="0.0"
ybuf="0.01"
models = [ "cmaqaodprod"+aod_qc_flag.lower() ]
lend_mdl = [ "PROD" ]
lend_obs = [ "OBS" ]
...
with open(plot_xml_file, 'a') as xml:
    ...
    xml.write("        <database>mv_grid2grid_met_verf_cmaqaod_"+database_date+"</database>\n")
    ...
    xml.write("            <title>MET_"+plot_var.upper()+"_"+verf_day_id.upper()+"_"+verf_cycle_id.upper()+"_"+aod_qc_flag.upper()+"_"+database_date+" - "+label_area+"</title>\n")
    ...
    xml.write("        <colors>c(\"#0000ffFF\",\"#000000FF\")</colors>\n")
    ...
    xml.write("        <plot_cmd/>\n")
    xml.write("        <legend>c(\"PROD\",\"OBS\")</legend>\n")
