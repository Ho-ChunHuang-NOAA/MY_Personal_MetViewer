...
with open(plot_xml_file, 'a') as xml:
    ...
    xml.write("            <title>MET_"+plot_var.upper()+"_"+verf_day_id.upper()+"_"+verf_cycle_id.upper()+"_"+aod_qc_flag.upper()+"_"+sdate.strftime(title_time_format)+"_"+edate.strftime(title_time_format)+" - "+label_area+"</title>\n")
    xml.write("            <x_label>TIME</x_label>\n")
    xml.write("            <y1_label>AOD</y1_label>\n")
    xml.write("            <y2_label/>\n")
    xml.write("            <caption/>\n")
    ...
    xml.write("        <title_size>1.6</title_size>\n")
